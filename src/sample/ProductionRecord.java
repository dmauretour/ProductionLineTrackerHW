...
class ProductionRecord {
  ...
  public ProductionRecord(
      int productionNum, String productName, String serialNum, Date dateProduced) {
  ...
  public ProductionRecord(Product product, int zeros) {
    ...
    this.serialNum = product.getManufacturer().substring(0, 3) + product.getType().code + IdNumber;
